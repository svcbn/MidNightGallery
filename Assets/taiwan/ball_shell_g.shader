    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 sceneUVs = (i.projPos.xy / i.projPos.w) + (node_6861*float2((node_2633.r*_a),(node_2633.g*_b))*saturate((partZ*2.173913+-0.1304348)));
